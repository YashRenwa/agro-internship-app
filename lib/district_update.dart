...
class DistrictUpdate extends StatefulWidget {
  @override
  _DistrictUpdateState createState() => _DistrictUpdateState();
}

class _DistrictUpdateState extends State<DistrictUpdate> {
  @override
        ...
        children: [
          ...
          Container(
            ...
            child: ClipRRect(
              ...
              child: Image(
                image: NetworkImage(
                    "https://images.unsplash.com/photo-1615149596797-da241c6f8e30?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1267&q=80"),
              ),
            ),
          ),
          SizedBox(
